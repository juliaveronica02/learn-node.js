...
var isSameError = (error, currentError) => isObject(error) &&
    ...
    Object.entries(error.types || {}).every(([key, value]) => (currentError.types || {})[key] === value);
...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, shouldUnregister = true, criteriaMode, } = {}) {
    ...
    const updateAndGetDirtyState = React.useCallback((name, shouldRender = true) => {
        ...
        const state = {
            isDirty: !deepEqual(get(getValues(), getFieldArrayParentName(name)), get(defaultValuesRef.current, getFieldArrayParentName(name))) || !isEmptyObject(formStateRef.current.dirtyFields),
